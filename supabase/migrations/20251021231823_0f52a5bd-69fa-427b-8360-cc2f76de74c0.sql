-- Fix the update_query_status function to update existing history record instead of creating a new one
-- This ensures the modified_by_email always reflects the author, not the approver
