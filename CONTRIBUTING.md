# Contributing to SQL Query Manager
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/daas-bi-sql-hub.git
   cd daas-bi-sql-hub
   ```
...
- Open a [GitHub Issue](https://github.com/montrellcruse/daas-bi-sql-hub/issues)
